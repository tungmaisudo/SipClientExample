...
public class SoundSenderDemo2 implements RTPAppIntf  {
    ...
    public SoundSenderDemo2(boolean isLocal, int uacRtpPort)  {
        DatagramSocket rtpSocket = null;
        DatagramSocket rtcpSocket = null;

        try {
            rtpSocket = new DatagramSocket(uacRtpPort);
            rtcpSocket = new DatagramSocket(uacRtpPort + 1);
        } catch (Exception e) {
